...
>Промежуточный вывод: Общая картина анализа ADMET для данной конформации схожа с препаратами аналогами. Предсказаны несколько вариантов токсичности. Требуются уточнения другими методами. **Данный изомер более перспективен.**
